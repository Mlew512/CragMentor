  ...
  const teamMembers = [
    {
      ...
      aboutMe:`An enthusiastic rock climber with motivation for challenging terrains, I've transitioned from a role as a Trauma ICU nurse to a dedicated software developer. My passion lies in problem-solving and creating user-friendly solutions that have a meaningful impact on people's lives each day.
      Whether I'm sport climbing in Spain, tackling T-Wall's roof cracks, or working on my next project in software development. I find inspiration in both physical and digital challenges. I came up with cragmentor to help others structure their climbing by focusing on building a good foundation of endurance and fundamentals and to balance climbing at your limit to optimize upward progression. If you have any feedback or would like to contribute to this app please dont hesitate to reach out on social media`,
    },
    {
      name: "Derek Marion",
      position: "Software Engineer",
    ...
    },
    {
      ...
      aboutMe:"I enjoy making applications that make it easier for people to get out and enjoy their passions. When I'm not working I enjoy hiking, playing sports and playing with my dogs, Mickey, Maple and Moab.",
    },
    {
      name: "John Prado",
      position: "Software Engineer",
