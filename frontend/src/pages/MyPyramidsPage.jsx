      ...
      {Array.isArray(pyramid) && pyramid.length >0 ?(
        <>
          <Row className="justify-content-center">
            <Col lg={3}>
              <Card className="text-center">
                <Link to={`/route/${pyramid[0].route_id}`}>
          ...
          <Row className="justify-content-center">
            <Col lg={3}>
              <Card className="text-center">
                <Link to={`/route/${pyramid[1].route_id}`}>
            ...
            <Col lg={3}>
              <Card className="text-center">
                <Link to={`/route/${pyramid[2].route_id}`}>
          ...
          <Row className="justify-content-center">
            <Col lg={3}>
              <Card className="text-center">
                <Link to={`/route/${pyramid[3].route_id}`}>
            ...
            <Col lg={3}>
              <Card className="text-center">
                <Link to={`/route/${pyramid[4].route_id}`}>
            ...
            <Col lg={3}>
              <Card className="text-center">
              <Link to={`/route/${pyramid[5].route_id}`}>
            ...
            <Col lg={3}>
              <Card className="text-center">
                <Link to={`/route/${pyramid[6].route_id}`}>
